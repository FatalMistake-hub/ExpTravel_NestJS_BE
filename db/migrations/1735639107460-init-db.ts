...
export class InitDb1735639107460 implements MigrationInterface {
    name = 'InitDb1735639107460'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "image_details" ADD "tour_id" numeric NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "tours" ADD "tourId" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "tour_category" ADD "toursTourId" numeric NOT NULL`);
