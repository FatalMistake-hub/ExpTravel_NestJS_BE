...
import { DateBookCreateDto } from './dto/day-book-create.dto';
...
export class DayBookController {
  ...
  // @Post('create')
  // async createDayBooking(@Body() dayBookDto: DateBookCreateDto): Promise<DateBookCreateDto> {
  ...
  @Delete('delete/:id')
  async deleteDayBooking(@Param('id') id: UUID): Promise<void> {
  ...
  // async getAllDayBooking(): Promise<DayBookDto[]> {
    // return this.dayBookService.getAllDayBook();
  // }
  ...
  // @Get('detail/:id')
  // async getDayBookingDetail(@Param('id') id: UUID): Promise<DayBookViewDto> {
